...
Use committed `docs/`, `features/`, and the GitHub wiki for durable design, user, and contributor documentation.
...
- Promote durable decisions from `.forge/` into committed docs or wiki pages.
