Feature: TDD micro-cycle workflow is observable and verifiable
  ...
  Rule: Forge records every testable behavior before implementation begins
    ...
    @rule-run-backlog @scenario-record-testable-items
    ...
    @rule-run-backlog @scenario-backlog-untracked
  ...
  Rule: Forge completes each recorded behavior through the TDD procedure
    ...
    @rule-tdd-item-flow @scenario-select-next-smallest-slice
    ...
    @rule-tdd-item-flow @scenario-verify-red
    ...
    @rule-tdd-item-flow @scenario-green-smallest-change
    ...
    @rule-tdd-item-flow @scenario-refactor-keeps-behavior
    ...
    @rule-tdd-item-flow @scenario-complete-or-block-item
  ...
  Rule: Forge verifies the completed backlog before final cleanup
    ...
    @rule-final-verification @scenario-run-full-suites
    ...
    @rule-final-verification @scenario-skip-missing-e2e-with-evidence
    ...
    @rule-final-verification @scenario-investigate-suite-failures
    ...
    @rule-final-verification @scenario-final-commit-anchored
